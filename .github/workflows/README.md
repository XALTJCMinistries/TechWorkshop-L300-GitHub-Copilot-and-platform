...
|------|------|-------------|---------------|
| `AZURE_CLIENT_ID` | Variable | Service principal client ID | `89ff6254-366b-...` |
| `AZURE_TENANT_ID` | Variable | Azure AD tenant ID | `8d535122-53a2-...` |
| `AZURE_SUBSCRIPTION_ID` | Variable | Azure subscription ID | `9ecaa2a8-2c4d-...` |
